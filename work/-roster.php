jpg"
                                    ...
                                    >
                                        <iframe id="video1" src="https://player.vimeo.com/video/957276970?autoplay=1&muted=1&loop=1&background=1&dnt=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                </div>
                    ...
                    <div> 
                        <div class="innerSidesSlide" data-author="COLORIST" data-title="WILHENDS NORVIL" data-index=41>
                            <figure>
                                <div class="poster poster1" id="imagePoster1" style="background: url('https://appollo.360cloudcenter.com/wilhends-norvil/gasoline/vlcsnap-2024-06-06-06h05m30s258.jpg') no-repeat center center;"></div>
                                <div class="iframe" data-preview1="https://appollo.360cloudcenter.com/wilhends-norvil/gasoline/vlcsnap-2024-06-06-06h05m30s258.jpg"
                                    ...
                                    >
                                        <iframe id="video1" src="https://player.vimeo.com/video/957277740?autoplay=1&muted=1&loop=1&background=1&dnt=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                </div>
                    ...
                    <div> 
                        <div class="innerSidesSlide" data-author="COLORIST" data-title="WILHENDS NORVIL" data-index=42>
                            <figure>
                                <div class="poster poster1" id="imagePoster1" style="background: url('https://appollo.360cloudcenter.com/wilhends-norvil/emmanuel/vlcsnap-2024-06-06-06h07m26s465.jpg') no-repeat center center;"></div>
                                <div class="iframe" data-preview1="https://appollo.360cloudcenter.com/wilhends-norvil/emmanuel/vlcsnap-2024-06-06-06h07m26s465.jpg"
                                    ...
                                    >
                                        <iframe id="video1" src="https://player.vimeo.com/video/957279355?autoplay=1&muted=1&loop=1&background=1&dnt=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                </div>
                    ...
                    <div> 
                        <div class="innerSidesSlide" data-author="COLORIST" data-title="WILHENDS NORVIL" data-index=43>
                            <figure>
                                <div class="poster poster1" id="imagePoster1" style="background: url('https://appollo.360cloudcenter.com/wilhends-norvil/coldteashortfilm/vlcsnap-2024-06-06-06h09m56s475.jpg') no-repeat center center;"></div>
                                <div class="iframe" data-preview1="https://appollo.360cloudcenter.com/wilhends-norvil/coldteashortfilm/vlcsnap-2024-06-06-06h09m56s475.jpg"
                                    ...
                                    >
                                        <iframe id="video1" src="https://player.vimeo.com/video/991787686?autoplay=1&muted=1&loop=1&background=1&dnt=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                                </div>
    ...
    <?php } ?>
                ...
                <ul class="colorful-list" <?php if(isset($_GET['action']) && $_GET['action']=='COLORIST'){ ?> style="display:inline-flex;" <?php }else{ ?> style="display:none;" <?php } ?> ></ul>
...
var slideCount=$('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').length;  
var slider = $('.bxslider').bxSlider({
  ...
  onSlideNext: function($slideElement, oldIndex, newIndex) {
        setTimeout(function() { 
            $('section.videoCarouselMovePage .rosterParent').addClass('slideAppear');
        }, 500);
  },
  onSlidePrev: function($slideElement, oldIndex, newIndex) {
    ...
    var slideCount=$('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').length;  
    var lastSlideCount=slideCount-8;
    // if(oldIndex==0 || oldIndex==1 || newIndex==0 || newIndex==1){
    //     moveSlideLast(lastSlideCount);
    // }
  },
  onSliderLoad: function() {
    ...
    var slide_2 = 6;
    var slide_3 = 7;
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide-first');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide-last');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]:nth-child('+slide_1+')').addClass('active-slide-first');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]:nth-child('+slide_2+')').addClass('active-slide');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]:nth-child('+slide_3+')').addClass('active-slide-last');
  },
  onSlideBefore: function($slideElement, oldIndex, newIndex) {
    $('section.videoCarouselMovePage .rosterParent').removeClass('slideAppear');
    
    var checkNewIndex=newIndex+1;
    var dataAuthor=$('section.videoCarouselMovePage .bx-wrapper .bxslider div[aria-hidden]:nth-child('+checkNewIndex+') div.innerSidesSlide').attr('data-author');
    var dataTitle=$('section.videoCarouselMovePage .bx-wrapper .bxslider div[aria-hidden]:nth-child('+checkNewIndex+') div.innerSidesSlide').attr('data-title');
    
    if(dataAuthor=='EDITOR'){
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 185}, 500);
    }
    if(dataAuthor=='COLORIST'){
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 275}, 500);
    }
    if(dataAuthor=='SOUND'){
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 355}, 500);
    }
    if(dataAuthor=='VFX'){
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 410}, 500);    
    }
    
    if(dataTitle=='GRIFFIN OLIS'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 970}, 500);
    }
    if(dataTitle=='ALEX PETERSON'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1100}, 500);
    }
    if(dataTitle=='DEVON SOLWOLD'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1260}, 500);
    }
    if(dataTitle=='ZACK PELLETIER'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1410}, 500);
    }
    if(dataTitle=='WILHENDS NORVIL'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1570}, 500);
    }
    if(dataTitle=='MIKE DE LA LUZ'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1740}, 500);
    }
    if(dataTitle=='DOUSON'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1850}, 500);
    }
    if(dataTitle=='JUMPER'){
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1930}, 500);  
    }
    console.log("before oldIndex : "+oldIndex);
    console.log("before newIndex : "+newIndex);
    var slide_1 = newIndex+4;
    var slide_2 = newIndex+5;
    var slide_3 = newIndex+6;
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide-first');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]').removeClass('active-slide-last');
    $('section.videoCarouselMovePage .bx-wrapper .bx-viewport .bxslider div[aria-hidden]:nth-child('+slide_1+')').addClass('active-slide-first');
  ...
  onSlideAfter: function($slideElement, oldIndex, newIndex) {
    ...
    // console.log("after oldIndex : "+oldIndex);
  ...
  function moveSlideLast(lastSlideCount){
      slider.goToSlide(lastSlideCount);
      setTimeout(function() {
  ...
  setTimeout(function() { 
    ...
    <?php if((isset($_GET['author']) && $_GET['author']=='GRIFFIN OLIS')){ ?>      
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 970}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='ALEX PETERSON')){ ?> 
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1100}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='DEVON SOLWOLD')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1260}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='ZACK PELLETIER')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1410}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='WILHENDS NORVIL')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1570}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='MIKE DE LA LUZ')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1740}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='DOUSON')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1850}, 500);
    <?php } ?>
    <?php if((isset($_GET['author']) && $_GET['author']=='JUMPER')){ ?>
        $('section.videoCarouselMovePage ul.editorsRight.editors').animate({scrollTop: 1930}, 500);    
    <?php } ?>
    <?php if((isset($_GET['action']) && $_GET['action']=='EDITOR')){ ?>      
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 185}, 500);
    <?php } ?>
    <?php if((isset($_GET['action']) && $_GET['action']=='COLORIST')){ ?>
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 275}, 500);
    <?php } ?>
    <?php if((isset($_GET['action']) && $_GET['action']=='SOUND')){ ?>
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 355}, 500);
    <?php } ?>
    <?php if((isset($_GET['action']) && $_GET['action']=='VFX')){ ?>
        $('section.videoCarouselMovePage ul.editorsLeft.editors').animate({scrollTop: 410}, 500);    
    <?php } ?> 
  }, 100);
...
<?php } ?>
  ...
  $('section.videoCarouselMovePage .bx-wrapper .bxslider').on('wheel', function(event) {
...
//   changes making
  $(document).on('click', 'section.videoCarouselMovePage ul.editorsLeft li', function() {
      var checkText=$(this).find('a').text();
    //   var slideNumber=0;
    //   $('section.videoCarouselMovePage ul.editorsLeft li[data-start]').each(function() {
    //     var checkedText=$(this).find('a').text();
    //     if(checkedText==checkText){
    //         slideNumber=$(this).attr('data-start');
    //         slideNumber=parseInt(slideNumber);
    //         $('section.videoCarouselMovePage ul.editorsLeft li').removeClass('active');
...
//   changes making
  $(document).on('click', 'section.videoCarouselMovePage ul.editorsRight li', function() {
      var checkText=$(this).find('a').text();
    //   var slideNumber=0;
    //   $('section.videoCarouselMovePage ul.editorsRight li[data-start]').each(function() {
    //     var checkedText=$(this).find('a').text();
    //     if(checkedText==checkText){
    //         slideNumber=$(this).attr('data-start');
    //         slideNumber=parseInt(slideNumber);
    //         $('section.videoCarouselMovePage ul.editorsRight li').removeClass('active');
    //         $(this).addClass('active');
    //     } 
    //   });
    //   slider.goToSlide(slideNumber);
  ...
  $(document).on('click', 'div.innerSidesSlide figure div.iframe', function() {
      var preview1=$(this).attr('data-preview1');
      var preview2=$(this).attr('data-preview2');
      var preview3=$(this).attr('data-preview3');
      var preview4=$(this).attr('data-preview4');
      var preview5=$(this).attr('data-preview5');
      var preview6=$(this).attr('data-preview6');
      var longVideo=$(this).attr('data-long-video');
