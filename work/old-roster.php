...
<section class="videoCarouselMovePage"> 
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="rosterParent slideAppear">
                <div class="rosterSlider"> 
...
$(document).ready(function(){
  ...
  $('.rosterSlider').slick({
    ...
    var dataAuthor=$('section.videoCarouselMovePage div.rosterSlider div.slick-current+div.slide div.innerSidesSlide').attr('data-author');
    var dataTitle=$('section.videoCarouselMovePage div.rosterSlider div.slick-current+div.slide div.innerSidesSlide').attr('data-title');
  ...
  $('section.videoCarouselMovePage div.rosterSlider').on('wheel', function(event) {
    if(event.originalEvent.deltaY < 0){
       $('div.rosterSlider button.slick-prev').click();
    }else{
       $('div.rosterSlider button.slick-next').click();   
    }
  });
