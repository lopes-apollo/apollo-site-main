...
<div class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li><a href="import-existing.php" class="<?php echo $current_page === 'import-existing.php' ? 'active' : ''; ?>"><i class="fas fa-download"></i> Import Existing</a></li>
        ...
        <li><a href="videos.php" class="<?php echo $current_page === 'videos.php' ? 'active' : ''; ?>"><i class="fas fa-video"></i> Videos</a></li>
