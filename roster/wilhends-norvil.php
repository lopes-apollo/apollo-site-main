  ...
  <div class="editorsMain editorsLeftMain" style="padding-top: 2rem;">
    ...
    <div class="editorsMain editorsRightMain">
        <ul class="editorsRight editors EditorGroupUL">
            ...
            <li data-start=44><a href="/roster/avery-niles">Avery Niles</a></li>
            <li class="active" data-start=37><a href="/roster/wilhends-norvil">Wilhends Norvil</a></li>
            <li><a style="color:transparent;">Inner</a></li>
            <li><a style="color:transparent;">Inner</a></li>
            <li><a style="color:transparent;">Inner</a></li> 
            <li><a style="color:transparent;">Inner</a></li>
  ...
  <script>
       $(document).on('click','div.video-container div.video',function(){
        ...
        function hidePreloader() {
            ...
            }, 2600); // Wait for fade-out animation to complete
        }
        ...
        setTimeout(() => {
            ...
            $("html, body").animate({
                scrollTop: $(".video-container div.video.wilhends-norvil").offset().top-330
            }, 2300, function() {
                hidePreloader();
            });
        }, 300);
